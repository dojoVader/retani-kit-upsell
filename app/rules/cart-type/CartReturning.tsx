...
export interface CartReturningProps {
      ...
      >
        ...
        <div style={{ padding: "14px 20px", borderBottom: "1px solid #f1f1f1" }}>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontWeight: "600", fontSize: "13px", color: "#202223" }}>Lavender Hand Cream</div>
              <div style={{ fontSize: "11px", color: "#6d7175", marginTop: "1px" }}>Last ordered Mar 12</div>
